...
from apps.feed.fanout import fanout_post_to_followers, remove_post_from_feeds, invalidate_user_feed
...
class TestFanoutPostToFollowers:
    ...
    def test_unknown_author_is_handled_gracefully(self, mock_task, db):
        ...
        fanout_post_to_followers(
            ...
            post_created_at=datetime(2025, 1, 1, tzinfo=timezone.utc),
            visibility="public",
        )
        mock_task.delay.assert_not_called()
