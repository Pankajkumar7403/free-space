...
class TestTextModerationFilterBlocklist:
    ...
    def test_exact_blocklist_match_returns_block(self):
        from apps.common.moderation.text_filter import TextModerationFilter
        from apps.common.moderation.constants import ModerationAction
        result = TextModerationFilter.get_instance().check("This contains badword123 here")
...
class TestImageClassifierStub:
    ...
    def test_image_moderation_result_dataclass(self):
        ...
        from apps.common.moderation.constants import ModerationAction, ModerationSeverity
