...
class UserPublicSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            "account_privacy", "is_verified", "date_joined",
...
class UserPrivateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            "first_name", "last_name", "bio", "website", "avatar",
            ...
            "account_privacy", "safe_messaging_mode", "location_sharing",
...
class UpdateProfileSerializer(serializers.Serializer):
    ...
    pronouns_custom             = serializers.CharField(max_length=50, required=False, allow_blank=True)
    pronouns_visibility         = serializers.CharField(max_length=10, required=False)
    gender_identity             = serializers.CharField(max_length=20, required=False, allow_blank=True)
    gender_identity_custom      = serializers.CharField(max_length=100, required=False, allow_blank=True)
    gender_identity_visibility  = serializers.CharField(max_length=10, required=False)
    sexual_orientation              = serializers.CharField(max_length=20, required=False, allow_blank=True)
    sexual_orientation_custom       = serializers.CharField(max_length=100, required=False, allow_blank=True)
...
class FollowSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model  = Follow
        fields = ["id", "follower_username", "following_username", "status", "created_at"]
        read_only_fields = fields