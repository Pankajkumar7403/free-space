...
urlpatterns = [
    ...
    path("<uuid:user_id>/followers/",   views.FollowersListView.as_view(),  name="followers"),
    path("<uuid:user_id>/following/",   views.FollowingListView.as_view(),  name="following"),

    # ── Follow requests (private accounts) ───────────────────────────────────
    path("follow-requests/<uuid:follower_id>/accept/", views.FollowRequestAcceptView.as_view(), name="follow-request-accept"),
    path("follow-requests/<uuid:follower_id>/",        views.FollowRequestRejectView.as_view(), name="follow-request-reject"),
